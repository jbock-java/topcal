...
class Dates {
    ...
    private static Set<LocalDate> createHighlight2023() {
        ...
        result.addAll(range(LocalDate.parse("2023-10-15"), LocalDate.parse("2023-10-22")));
        ...
        result.addAll(range(LocalDate.parse("2023-12-25"), LocalDate.parse("2023-12-28")));
        return result;
    }
    ...
    private static Set<LocalDate> createHighlight() {
        ...
        result.addAll(range(LocalDate.parse("2024-03-16"), LocalDate.parse("2024-03-22")));
        ...
        result.addAll(range(LocalDate.parse("2024-06-22"), LocalDate.parse("2024-07-13")));
        ...
        result.addAll(range(LocalDate.parse("2024-10-03"), LocalDate.parse("2024-10-11")));
